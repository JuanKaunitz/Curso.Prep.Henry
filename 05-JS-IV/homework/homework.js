...
function pasarUsuarioAPremium(usuarios) {
  ...
  for (var ind= 0; ind < usuarios.length; ind++){
    usuarios[ind].esPremium = true;
  }
  return usuarios;
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  var sumaLikes = 0
  for (ind=0; ind < usuario.posts.length; ind++){
  //  console.log (ind);
  //  console.log(usuario.posts[ind].likes);
    sumaLikes = sumaLikes + usuario.posts[ind].likes;
  }  
  return sumaLikes;
}
